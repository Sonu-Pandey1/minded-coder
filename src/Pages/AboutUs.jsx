        ...
        <div className="container">
          ...
          <div className="row row2">
            <div className="col col2 text-center">
              <h2 className="mb-5">Why Choose Minded Coder</h2>
          ...
          <div className="row row3">
            <div className="col col3">
              <h3 className=" mt-5 pt-5 gradient-text">Benifits</h3>
              <div className=" text-center 0cardsContainer d-flex justify-content-between mt-5 flex-wrap">
                <Card  imgUrl={"https://scalive.in/assets/images/category/1.png"} pera={"We want to help you in building a career you love. Get trained in cutting edge technologies, with hands-on practice, helping you in changing your career or succeeding in the job you already have."} title={"Give a flight to your career"} />
                <Card imgUrl={"https://scalive.in/assets/images/category/2.png"} pera={"We provide Daily/alternate days Classes at our academy. Also, students get assistance throughout online/offline classes.They can easily join our online classes at their comfort zone at anywhere in any place."} title={"Offline & Online classes"} />
                <Card imgUrl={"https://scalive.in/assets/images/category/3.png"} pera={"We pay equal importance to student's practical knowledge as well as theoretical lessons. We also provide assistance in the revision of course material like pdf, ppt, codes and hand written notes for students."} title={"Practice and revise"} />
                <Card imgUrl={"https://scalive.in/assets/images/category/4.png"} pera={"Our courses are designed keeping one thing in mind that student should get prepared for interviews after completing this course, so if you are struggling with interviews you are at right place."} title={"Become Job Ready"} />
                <Card className="card" imgUrl={"https://scalive.in/assets/images/category/5.png"} pera={"We know that being a noob in technology, you will have many doubts while learning, our 24x7 doubtsin this world helping you in utilizing your free time for new skill  solving support will let you resolve your queries in minutes."} title={"Seamless Doubt Solving"} />
