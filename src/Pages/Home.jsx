      ...
      <div className="fetures_section m-4">
        <div className="container ">
          <div className="row justify-content-between">
            <div className="col-12 col-sm-4 col-md-4 col-lg-4 col1 p-3">
              <p className="">Get Everything You Need !</p>
            </div>
            <div className="col-12 col-sm-4 col-md-4 col-lg-4   box  border p-4 align-content-center">
              <div className="row">
            ...
            <div className="col-12 col-sm-4 col-md-4 col-lg-4 col3 box  border p-4 align-content-center">
              <div className="row">
                <div className="col col-4 text-center">
