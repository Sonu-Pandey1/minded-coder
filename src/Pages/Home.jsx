          ...
          <div className="container  ">
            <div className="row">
              <div className="col p-4 firstCol align-content-center">
                ...
                <div>
                  <NavLink to={"/Courses"} className=" btn btn-outline-warning" >
                    Courses
                  </NavLink>
                  <NavLink to={"/tutorial"} className="ms-4 btn btn-outline-dark" >
                    Tutorial
                  </NavLink>
                </div>
              </div>
              <div className="col col2 pt-5 align-content-center">
      ...
      <div className="fetures_section m-4">
        <div className="container ">
          <div className="row justify-content-between">
            <div className="col-12 col-sm-4 col-md-4 col-lg-3 col1 p-3">
              <p className="">Get Everything You Need !</p>
            </div>
            <div className="col-12 col-sm-4 col-md-4 col-lg-4 mb-3 mx-auto  box  border p-4 align-content-center">
              <div className="row">
            ...
            <div className="col-12 col-sm-4 col-md-4 col-lg-4 mb-3 mx-auto  col3 box  border p-4 align-content-center">
              <div className="row">
                <div className="col col-4 text-center">
          ...
          <div className="row justify-content-center">
            <div className="col-12 col-sm-4 col-md-4 col-lg-4  box m-3 border p-4 ">
              <div className="row">
                <div className="col col-4 text-center">
        ...
        <div className="container c2">
          <div className="row">
            <div className=" d-flex justify-content-between">
              ...
              <NavLink to={"/Courses"} className=" text-center pt-2 btn btn-dark" >
                Explore All Course
              </NavLink>
            </div>
          </div>
